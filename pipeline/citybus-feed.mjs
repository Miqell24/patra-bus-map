// Larisa has no downloadable GTFS, so this writes one.
//
...
// own passenger site at patra.citybus.gr — the citybus.gr platform that several Greek
...
const HOST = 'patra.citybus.gr';
const API = 'https://rest.citybus.gr/api/v1';
const AGENCY_ID = 'ASTIKO_ACHAIAS';
const AGENCY_NAME = 'Αστικό ΚΤΕΛ Αχαΐας Α.Ε.';
const AGENCY_URL = 'https://www.astikopatras.gr';
