...
Patra: 2 x 2 road tiles over the 18 x 18 km the network covers (Rio and the
bridge approach north-east, Ano and Kato Ovrya south, the university and the
hospital on the hill, the port and Tsoukaleika along the coast). No rail file
for the buses.
...
# must match pipeline/download.sh — the stop cloud is 38.1540..38.3164 N, 21.6314..21.8353 E;
# this adds ~2 km of margin so a route never runs off the graph at the edge
S, N, W, E = 38.130, 38.340, 21.600, 21.865
